    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-gray-50 to-white overflow-x-hidden">
        ...
        <div className="container mx-auto px-6">
          <div className="flex h-20 items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              {"Home, Courses, Features, Success Stories, Pricing".split(", ").map((item) => (
                <a
                  key={item}
      ...
      <footer className="bg-gradient-to-br from-gray-900 to-black text-white py-16">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {"About Us, Courses, Instructors, Success Stories, Blog".split(", ").map((link) => (
                  <li key={link}>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {"Help Center, Contact Us, Privacy Policy, Terms of Service, Refund Policy".split(", ").map((link) => (
                  <li key={link}>
                    <a href="#" className="text-gray-400 hover:text-white transition-colors">
                      {link}
                    </a>
          ...
          <div className="border-t border-gray-800 pt-8 mt-12 text-center text-gray-400 text-sm">
